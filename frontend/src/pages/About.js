...
const About = () => {
  return (
    <div className='about'>
      ...
      <p> DIY4rent tiene como objetivo crear un marketplace online para el alquiler
          ...
          de entusiastas del bricolaje.<br></br> Para los usuarios, el marketplace ofrece acceso a una
          amplia gama de herramientas sin necesidad de comprarlas, ahorro económico y la satisfacción
          de contribuir a un modelo de consumo más responsable con el medio ambiente.
</p>
    </div>
  );
};
